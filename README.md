...
| メンバー | 役割 | 主に担当したこと |
|---|---|---|
| [@Showgo1130](https://github.com/Showgo1130) | **開発基盤と情報推定** | 対戦を1手ずつ見返すバトルビュアー<br>配布 PDF から紙のデッキを刷るツール<br>相手の手札・山札に何が残っているかの推定<br>その推定を使った先読み<br>相手が何のデッキかの判別（条件分岐版と機械学習版）<br>盤面の有利不利を点数で見積もるモデル<br>各部品を1本の意思決定につなぐ統合 |
| [@tsuoimorioka](https://github.com/tsuoimorioka) | **探索と強化学習** | このターンで勝ち切れる手順を見つける探索<br>試行をくり返して手を評価するモンテカルロ探索<br>1手にかける時間の配分制御<br>自己対戦で強くする強化学習（PPO）<br>それを複数マシンに分散させる仕組み<br>デッキの実装 |
| [@koshincarrier-pixel](https://github.com/koshincarrier-pixel) | **ルールベース AI** | 条件分岐で行動を決める中核部分<br>デッキごとの動かし方を記述する仕組み<br>エネルギーを誰に付けるか・いつ「にげる」かの判断<br>学習モデルの再学習<br>相手のデッキに応じた処理の切り替え |
