...
def main() -> None:
    ...
    ap.add_argument("--seed-base", type=int, default=1010000)
    ap.add_argument("--out", default=str(_ROOT / "kaggle_replays" / "_og_r8_ablate_drapa_results.json"))
    args = ap.parse_args()

    out = {}
    for cfg in ("abl_5_full_og_r7", "abl_5_full_og_r8_lethalonly", "abl_5_full_og_r8_briaronly", "abl_5_full_og_r8"):
        out[cfg] = {}
