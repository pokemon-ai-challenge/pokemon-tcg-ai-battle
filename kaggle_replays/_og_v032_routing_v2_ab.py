...
abl_5_full_og_routing_v2(threshold 0.8、提出55477812と同じ)。
...
COMMON = dict(
    ...
    games=1000, progress_every=50, workers=12,
)


def main() -> None:
    out = {}
    for tag, cfg_a, seed in (("baseline", "abl_5_full", 964000),
                             ("routing08", "abl_5_full_og_routing_v2", 965000)):
