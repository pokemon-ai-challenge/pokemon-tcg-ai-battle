...
def main() -> None:
    ...
    ap.add_argument("--seed-base", type=int, default=995000)
    ap.add_argument("--out", default=str(_ROOT / "kaggle_replays" / "_og_r8_field_ab2_results.json"))
    args = ap.parse_args()
