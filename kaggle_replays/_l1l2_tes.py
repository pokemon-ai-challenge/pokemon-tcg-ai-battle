"""Phase19.9 後半: EntityQ_EPool vs TES の独立 forced-action L1/L2(§34-§43)。
...
def main() -> None:
    ...
    ap.add_argument("--offset", type=int, default=1700000)
    ...
    out = _HERE / "_p199_{}.jsonl.gz".format(args.tag)
