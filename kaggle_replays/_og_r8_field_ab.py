...
FIELD = [
    ("alakazam", 400, "_g2"),            # 743=ガード対象
    ("mega_froslass_ex", 400, "_g2"),    # 861=ガード対象
    ("lopunny_megafroslass", 400, "_g2"),  # 861=ガード対象(新BC相手。実ラダー脅威の再現は不完全)
    ("yadoking", 200, "_g2"),              # 新BC相手(同上)
    ("marnie_grimmsnarl_ex", 150, "_g2"),
    ("dragapult_ex", 150, "_g2"),
    ("mega_lucario_ex", 150, ""),
    ("ogerpon_teal_ex", 100, "_g2"),
    ("archaludon_ex", 100, "_g2"),
    ("crustle", 100, "_g2"),
    ("shirona_garchomp_ex", 100, "_g2"),
    ("omatsuri_ondo", 100, "_g2"),
    ("rocket_mewtwo_ex", 100, "_g2"),
]
...
def main() -> None:
    ...
    ap.add_argument("--out", default=str(_ROOT / "kaggle_replays" / "_og_r8_field_ab_results.json"))
    args = ap.parse_args()

    out = {}
    for cfg in ("abl_5_full_og_r7", "abl_5_full_og_r8"):
        out[cfg] = {}
