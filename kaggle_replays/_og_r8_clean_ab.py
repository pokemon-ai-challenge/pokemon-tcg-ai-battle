...
def main() -> None:
    ...
    ap.add_argument("--seed-base", type=int, default=1020000)
    ap.add_argument("--out", default=str(_ROOT / "kaggle_replays" / "_og_r8_clean_ab_results.json"))
    args = ap.parse_args()

    out = {}
    for cfg in ("abl_5_full_og_r7_isorng", "abl_5_full_og_r8"):
        out[cfg] = {}
