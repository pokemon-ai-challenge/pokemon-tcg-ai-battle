...
def main() -> None:
    ...
    ap.add_argument("--seed-base", type=int, default=1030000)
    ap.add_argument("--out", default=str(_ROOT / "kaggle_replays" / "_og_r10_clean_ab_results.json"))
    args = ap.parse_args()

    out = {}
    for cfg in ("abl_5_full_og_r8", "abl_5_full_og_r10"):
        out[cfg] = {}
