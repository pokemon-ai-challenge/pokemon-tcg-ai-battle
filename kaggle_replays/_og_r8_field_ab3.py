...
FIELD = [
    ("dragapult_ex", 600, "_g2"),
    ("marnie_grimmsnarl_ex", 300, "_g2"),
    ("mega_lucario_ex", 300, ""),
]
...
def main() -> None:
    ...
    ap.add_argument("--seed-base", type=int, default=1005000)
    ap.add_argument("--out", default=str(_ROOT / "kaggle_replays" / "_og_r8_field_ab3_results.json"))
    args = ap.parse_args()
