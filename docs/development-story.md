...
トップページに載せた「このコンペの何が難しいのか」「そこに至るまで」「うまくいかなかったこと」を、背景まで含めて書いたページです。最後にメンバー4人それぞれの担当の内訳を載せています。
...
**3. フーディンデッキ ＋ 模倣学習**
ルールベースは、記述した範囲でしか判断できません。上位プレイヤーのリプレイから「その盤面で実際に選ばれた手」を教師として学習させれば、自分たちが言語化できていない判断も獲得できるのではないか、という仮説で模倣学習に移行しました。
