"""ルールベース マリィのオーロンゲex 対戦相手(04: 標準+クセロシキ妨害型, jiatu.l, LB 1116.5)。

出典: `kaggle_replays/meta_analysis/archetype_decks/marnie_grimmsnarl_ex/04.csv`
...
league から使うときは `--deck-b opponents/grimmsnarl_ex_deck_04.csv` を必ず対応させること
...
_DECK_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "grimmsnarl_ex_deck_04.csv")
