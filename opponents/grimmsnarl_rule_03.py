"""ルールベース マリィのオーロンゲex 対戦相手(03: 標準+ハンディサーキュレーター妨害型, bono, LB 1150.8)。

出典: `kaggle_replays/meta_analysis/archetype_decks/marnie_grimmsnarl_ex/03.csv`
...
league から使うときは `--deck-b opponents/grimmsnarl_ex_deck_03.csv` を必ず対応させること
...
_DECK_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "grimmsnarl_ex_deck_03.csv")
